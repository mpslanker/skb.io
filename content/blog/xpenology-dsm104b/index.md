...
description = 'Complete guide to setting up Xpenology DSM 6.1.x on VMware ESXi 7, including VM configuration and synoboot image setup.'
draft = false

categories = ['Virtualization']
tags = ['xpenology', 'dsm', 'vmware', 'esxi', 'synology', 'virtualization', 'nas']
